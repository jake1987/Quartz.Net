...
{
    public class BMSSalesCKDDDAL
    {
        public int Insert(BMSSalesCKDDInfo model)
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append(" INSERT INTO BMS_SALES_CKD_D (");
        ...
        public int Update(BMSSalesCKDDInfo model)
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append(" UPDATE BMS_SALES_CKD_D SET ");
            sbSql.Append(" SO=@SO");
