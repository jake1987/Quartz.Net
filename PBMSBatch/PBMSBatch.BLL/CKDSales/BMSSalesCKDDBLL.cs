...
{
    public class BMSSalesCKDDBLL
    {
        private BMSSalesCKDDAL bmsSalesDAL = new BMSSalesCKDDAL();
        private BMSSalesCKDDDAL bmsSalesDDAL = new BMSSalesCKDDDAL();
        public void makeSalesDFiles(DataRow oRd)
        {
            BMSSalesCKDDInfo SalesD = new BMSSalesCKDDInfo();
            try
            {
